...
void bindStatistics(nb::module_ &m) {
    ...
    .def_static("serializeData", &Statistics::serializeData, "data"_a)
    .def_static("deserializeData", &Statistics::deserializeData, "data"_a)

    .def("addStatistic", &Statistics::addStatistic, "name"_a, "value"_a)

    .def("setExtended", &Statistics::setExtended, "extended"_a)
    .def("setRefImageId", &Statistics::setRefImageId, "id"_a)
    .def("setRefImageMapId", &Statistics::setRefImageMapId, "id"_a)
    .def("setLoopClosureId", &Statistics::setLoopClosureId, "id"_a)
    .def("setLoopClosureMapId", &Statistics::setLoopClosureMapId, "id"_a)
    .def("setProximityDetectionId", &Statistics::setProximityDetectionId, "id"_a)
    .def("setProximityDetectionMapId", &Statistics::setProximityDetectionMapId, "id"_a)
    .def("setStamp", &Statistics::setStamp, "stamp"_a)

    .def("addSignatureData", &Statistics::addSignatureData, "data"_a)
    .def("setSignaturesData", &Statistics::setSignaturesData, "data"_a)

    .def("setPoses", &Statistics::setPoses, "poses"_a)
    // .def("setConstraints", &Statistics::setConstraints, "constraints"_a)
    .def("setMapCorrection", &Statistics::setMapCorrection, "mapCorrection"_a)
    .def("setLoopClosureTransform", &Statistics::setLoopClosureTransform, "loopClosureTransform"_a)
    .def("setLocalizationCovariance", &Statistics::setLocalizationCovariance, "covariance"_a)
    .def("setLabels", &Statistics::setLabels, "labels"_a)
    .def("setWeights", &Statistics::setWeights, "weights"_a)
    .def("setPosterior", &Statistics::setPosterior, "posterior"_a)
    .def("setLikelihood", &Statistics::setLikelihood, "likelihood"_a)
    .def("setRawLikelihood", &Statistics::setRawLikelihood, "rawLikelihood"_a)
    .def("setLocalPath", &Statistics::setLocalPath, "localPath"_a)
    .def("setCurrentGoalId", &Statistics::setCurrentGoalId, "goal"_a)
    .def("setReducedIds", &Statistics::setReducedIds, "reducedIds"_a)
    .def("setWmState", &Statistics::setWmState, "state"_a)
    .def("setOdomCachePoses", &Statistics::setOdomCachePoses, "poses"_a)
