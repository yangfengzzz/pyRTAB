...
class Memory:
    ...
    def saveOptimizedMesh(self, arg0: numpy.array, arg1: Sequence[Sequence[Sequence[int]]], arg2: Sequence[Sequence["Eigen::Matrix<float, 2, 1, 0, 2, 1>"]], arg3: numpy.array, /) -> None: ...

    def loadOptimizedMesh(self, arg0: Sequence[Sequence[Sequence[int]]], arg1: Sequence[Sequence["Eigen::Matrix<float, 2, 1, 0, 2, 1>"]], arg2: numpy.array, /) -> numpy.array: ...
...
class Rtabmap:
    ...
    @overload
    def process(self, data: SensorData, odomPose: Transform, odomCovariance: "cv::Mat", odomVelocity: Sequence[float], externalStats: Mapping[str, float]) -> bool: ...
    ...
    @overload
    def process(self, image: "cv::Mat", id: int, externalStats: Mapping[str, float]) -> bool: ...
    ...
    def close(self, arg0: bool, arg1: str, /) -> None: ...
    ...
    def getPose(self, arg: int, /) -> Transform: ...
    ...
    def setTimeThreshold(self, arg: float, /) -> None: ...

    def getMemoryThreshold(self) -> int: ...

    def setMemoryThreshold(self, arg: int, /) -> None: ...

    def setInitialPose(self, arg: Transform, /) -> None: ...

    def triggerNewMap(self) -> int: ...

    def labelLocation(self, arg0: int, arg1: str, /) -> bool: ...

    def setUserData(self, arg0: int, arg1: "cv::Mat", /) -> bool: ...

    def generateDOTGraph(self, arg0: str, arg1: int, arg2: int, /) -> None: ...

    def exportPoses(self, arg0: str, arg1: bool, arg2: bool, arg3: int, /) -> None: ...
    ...
    def setWorkingDirectory(self, arg: str, /) -> None: ...

    def rejectLastLoopClosure(self) -> None: ...

    def deleteLastLocation(self) -> None: ...

    def getSignatureCopy(self, arg0: int, arg1: bool, arg2: bool, arg3: bool, arg4: bool, arg5: bool, arg6: bool, /) -> Signature: ...
    ...
    def detectMoreLoopClosures(self, arg0: float, arg1: float, arg2: int, arg3: bool, arg4: bool, arg5: ProgressState, arg6: float, /) -> int: ...

    def globalBundleAdjustment(self, arg0: int, arg1: bool, arg2: int, arg3: float, /) -> bool: ...

    def cleanupLocalGrids(self, arg0: Mapping[int, Transform], arg1: "cv::Mat", arg2: float, arg3: float, arg4: float, arg5: int, arg6: bool, /) -> int: ...

    def refineLinks(self) -> int: ...

    def addLink(self, arg: Link, /) -> bool: ...

    def getInformation(self, arg: "cv::Mat", /) -> "cv::Mat": ...

    def addNodesToRepublish(self, arg: Sequence[int], /) -> None: ...

    def getPathStatus(self) -> int: ...

    def clearPath(self, arg: int, /) -> None: ...

    @overload
    def computePath(self, targetNode: int, global: bool) -> bool: ...
    ...
    def getForwardWMPoses(self, arg0: int, arg1: int, arg2: float, arg3: int, /) -> dict[int, Transform]: ...

    def getPaths(self, arg0: Mapping[int, Transform], arg1: Transform, arg2: int, /) -> dict[int, dict[int, Transform]]: ...

    def adjustLikelihood(self, arg: Mapping[int, float], /) -> None: ...
