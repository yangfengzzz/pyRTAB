...
class Feature2D:
    ...
    def generateKeypoints(self, image: numpy.array, mask: numpy.array) -> "std::__1::vector<cv::KeyPoint, std::__1::allocator<cv::KeyPoint>>": ...

    def generateDescriptors(self, image: numpy.array, keypoints: "std::__1::vector<cv::KeyPoint, std::__1::allocator<cv::KeyPoint>>") -> numpy.array: ...

    def generateKeypoints3D(self, data: SensorData, keypoints: "std::__1::vector<cv::KeyPoint, std::__1::allocator<cv::KeyPoint>>") -> "std::__1::vector<cv::Point3_<float>, std::__1::allocator<cv::Point3_<float>>>": ...
...
class Odometry:
    ...
    @overload
    @staticmethod
    def create(type: OdometryType) -> None: ...
...
class SensorCaptureInfo:
    ...
    @property
    def odomVelocity(self) -> "std::__1::vector<float, std::__1::allocator<float>>": ...

    @odomVelocity.setter
    def odomVelocity(self, arg: "std::__1::vector<float, std::__1::allocator<float>>", /) -> None: ...
